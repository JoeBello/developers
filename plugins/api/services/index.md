        ...
        <tr>
            ...
            <td>
                ...
                <ul>
                    ...
                    <li><strong>unique</strong> - <code>{boolean|string}</code> - Whether to close any other open dialogs. <code>true</code> means close any other dialogs. Alternatively, a CSS class name can be passed to close related dialogs. *Note: if implementing <code>znModal</code> with a plugin that uses the <code>zn-plugin-form-top</code> location, the value of <code>unique</code> must be set to <code>false</code>. </li>
